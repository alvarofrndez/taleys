...
import styles from '@/assets/auth/projects/books/summary.module.scss'
...
export default function BookSummary({ project, book }) {
    return (
        <section className={styles.summary}>
            <div className={styles.fastActions}>
                <header>
                    ...
                    <span className={styles.subtitle}>Crea nuevo contenido para tu libro</span>
                </header>
