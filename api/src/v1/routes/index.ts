...
import books_saga_universe_routes from '@/modules/universes/sagas/books/book.routes'
...
router.use('/projects/:project_id/universes/:universe_idsagas/:saga_id/books', books_saga_universe_routes)
